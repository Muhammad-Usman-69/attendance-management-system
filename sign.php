...
<body class="bg-[#F8F8F8]">
  ...
  <div class="min-h-screen flex items-center justify-center flex-col space-y-8">
    ...
    <form action="partials/_sign-handler.php" method="post"
      ...
      <div class="flex flex-col space-y-1">
        ...
        <input class="text-sm p-1.5 px-3 outline-none border" type="text" name="name" id="name" placeholder="John Doe"
          minlength="5" required />
      </div>
      <div class="flex flex-col space-y-1">
        <label for="email" class="text-sm">Email:</label>
        <input class="text-sm p-1.5 px-3 outline-none border" type="text" name="email" id="email"
          placeholder="example@example.com" minlength="5" required />
      </div>
      <div class="flex flex-col space-y-1">
      ...
      <div>
        <p>
          ...
          <a href="log" class="underline hover:no-underline">log in</a>
        </p>
      </div>
    </form>
  </div>
